...
namespace Accord.MachineLearning.DecisionTrees.Learning
{
    ...
    /// <summary>
    ///   C4.5 Learning algorithm for <see cref="ModifiedDecisionTree">Decision Trees</see>.
    /// </summary>
    /// 
    /// <remarks>
    /// <para>
    ...
    ///
    [Serializable]
    public class C45Learning : DecisionTreeLearningBase, ISupervisedLearning<ModifiedDecisionTree, double[], int>
    {
        ...
        /// 
        public C45Learning(ModifiedDecisionVariable[] attributes)
            : base(attributes)
        {
        }
        ...
        /// 
        public C45Learning(ModifiedDecisionTree tree)
        {
            init(tree);
        }
        ...
        /// 
        public ModifiedDecisionTree Learn(double[][] x, int[] y, double[] weights = null)
        {
            if (Model == null)
