...
namespace Accord.MachineLearning.DecisionTrees.Learning
{
    ...
    /// 
    [Serializable]
    public class DecisionTreeLearningBase : ParallelLearningBase, IEnumerable<ModifiedDecisionVariable>
    {

        private ModifiedDecisionTree tree;
        ...
        private IList<ModifiedDecisionVariable> attributes;
        ...
        /// </summary>
        /// 
        public IList<ModifiedDecisionVariable> Attributes
        {
        ...
        /// </summary>
        /// 
        public ModifiedDecisionTree Model
        {
            get { return tree; }
            set { tree = value; }
        }
        ...
        public DecisionTreeLearningBase()
        {
            ...
            this.attributes = new List<ModifiedDecisionVariable>();
        }

        /// <param name="attributes">The attributes to be processed by the induced tree.</param>
        //
        public DecisionTreeLearningBase(ModifiedDecisionVariable[] attributes)
        {
            this.attributes = new List<ModifiedDecisionVariable>(attributes);
        }
        ...
        /// </summary>
        /// 
        public void Add(ModifiedDecisionVariable variable)
        {
        ...
        public IEnumerator<ModifiedDecisionVariable> GetEnumerator()
        {
