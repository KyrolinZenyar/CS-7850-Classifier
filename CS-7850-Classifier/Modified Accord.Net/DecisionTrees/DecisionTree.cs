...
namespace Accord.MachineLearning.DecisionTrees
{
    ...
    ///   and example of learning, please see the documentation pages for the <see cref="ModifiedID3Learning">
    ...
    ///   <para>For more examples with discrete variables, please see <see cref="ModifiedID3Learning"/></para>
    /// 
    /// <para>
    ...
    /// </example>
    /// 
    /// <seealso cref="ModifiedID3Learning"/>
    /// <seealso cref="C45Learning"/>
    /// <seealso cref="RandomForestLearning"/>
    /// 
    [Serializable]
    [SerializationBinder(typeof(ModifiedDecisionTree.DecisionTreeBinder))]
    public class ModifiedDecisionTree : MulticlassClassifierBase, IEnumerable<DecisionNode>
    {
        ...
        /// <summary>
        ///   Creates a new <see cref="ModifiedDecisionTree"/> to process
        ...
        /// 
        public ModifiedDecisionTree(IList<ModifiedDecisionVariable> inputs, int classes)
        {
            if (classes <= 0)
        ...
        public static ModifiedDecisionTree Load(Stream stream)
        {
            return Accord.IO.Serializer.Load<ModifiedDecisionTree>(stream);
        }
        ...
        public static ModifiedDecisionTree Load(string path)
        {
            return Accord.IO.Serializer.Load<ModifiedDecisionTree>(path);
        }
#endif
...
#pragma warning disable 0649
        ...
        class DecisionTree_2_13
        {
            ...
            public static implicit operator ModifiedDecisionTree(DecisionTree_2_13 obj)
            {
                var tree = new ModifiedDecisionTree(obj.Attributes, obj.OutputClasses);
                tree.Root = obj.Root;
