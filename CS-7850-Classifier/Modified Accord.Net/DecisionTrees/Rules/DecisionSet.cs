...
namespace Accord.MachineLearning.DecisionTrees.Rules
{
    ...
    /// <remarks>
    /// <para>
    ///   Decision rule sets can be created from <see cref="ModifiedDecisionTree"/>s using their
    ///   <see cref="ModifiedDecisionTree.ToRules()"/> method. An example is shown below.</para>
    /// </remarks>
    /// 
    /// <example>
    ...
    public class DecisionSet : MulticlassClassifierBase<double[]>, IEnumerable<DecisionRule>
    {
        ...
        /// <summary>
        ///   Creates a new <see cref="DecisionSet"/> from a <see cref="ModifiedDecisionTree"/>.
        /// </summary>
        /// 
        /// <param name="tree">A <see cref="ModifiedDecisionTree"/>.</param>
        /// 
        /// <returns>A <see cref="DecisionSet"/> that is completely 
        /// equivalent to the given <paramref name="tree"/></returns>
        /// 
        public static DecisionSet FromDecisionTree(ModifiedDecisionTree tree)
        {
