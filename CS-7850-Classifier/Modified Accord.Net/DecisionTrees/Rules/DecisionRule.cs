...
namespace Accord.MachineLearning.DecisionTrees.Rules
{
    ...
    /// <example>
    /// <para>
    ///   The simplest way to create a set of decision rules is by extracting them from an existing <see cref="ModifiedDecisionTree"/>.
    ///   The example below shows how to create a simple decision tree and convert it to a <see cref="DecisionSet">set of rules</see>
    ///   using its <see cref="ModifiedDecisionTree.ToRules()"/> method.</para>
    ...
    /// <seealso cref="ModifiedDecisionTree"/>
        ...
        IEquatable<DecisionRule>, IComparable<DecisionRule>
    {
        ...
        /// 
        public DecisionRule(IList<ModifiedDecisionVariable> variables,
        ...
        /// <summary>
        ///   Creates a new <see cref="DecisionRule"/> from a <see cref="ModifiedDecisionTree"/>'s
        ///   <see cref="DecisionNode"/>. This node must be a leaf, cannot be the root, and
        ///   should have one output value.
        /// </summary>
        /// 
        /// <param name="node">A <see cref="DecisionNode"/> from a <see cref="ModifiedDecisionTree"/>.</param>
        /// 
        ...
        public static DecisionRule FromNode(DecisionNode node)
        {
            ...
            ModifiedDecisionTree owner = current.Owner;
