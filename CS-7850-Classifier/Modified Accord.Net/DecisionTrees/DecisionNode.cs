...
namespace Accord.MachineLearning.DecisionTrees
{
    ...
    public class DecisionNode : IEnumerable<DecisionNode>
    {
        ...
        [NonSerialized]
        private ModifiedDecisionTree owner;
        ...
        /// <summary>
        ///   Gets the <see cref="ModifiedDecisionTree"/> containing this node.
        /// </summary>
        /// 
        public ModifiedDecisionTree Owner
        {
            get { return owner; }
            set { owner = value; }
        }
        ...
        /// 
        public DecisionNode(ModifiedDecisionTree owner)
        {
            Owner = owner;
